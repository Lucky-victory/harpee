...
HarpeeUtilities.prototype.alterRole = async function(options) {
   let res;
   if(!Util.isObject(options)){
      throw new Error('`options` must be an object');
   }
...
HarpeeUtilities.prototype.alterUser= async function(options) {
   let res;
...
HarpeeUtilities.prototype.listRoles = async function() {
   let res;

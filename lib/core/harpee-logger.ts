...
export default class HarpeeLogger extends HarpeeHttp {
    ...
    //  async getJob(options, callback?: HarpeeResponseCallback<T>) {
    //      try {
    //          const id = { options };
    //          if (!id) {
    ...
    //  async readTransactionLog(options, callback?: HarpeeResponseCallback<T>) {
    //      try {
    //          const schema =
    ...
    //  async readTransactionLogByTimestamp(
    //      options,
    ...
    //  async readTransactionLogByUsername(
    //      options,
    //      callback?: HarpeeResponseCallback<T>
    //  ) {
    //      try {
    ...
    //  async readTransactionLogByHashValue(
    //      options,
    //      callback?: HarpeeResponseCallback<T>
    //  ) {
    //      try {
    ...
    //   * @returns {(Promise<any> | void)}
    //   */
    //  async deleteRecordsBefore(options, callback?: HarpeeResponseCallback<T>) {
    //      try {
    //          const schema =
    //              options.schema || this.modelSchemaConfig.schemaObject.name;
    //          const table = options.table || this.modelSchemaConfig.modelName;
    ...
    //  async deleteTransactionLogsBefore(
    //      options,
    //      callback?: HarpeeResponseCallback<T>
    //  ) {
    //      try {
    ...
    //  *
    //  */
    //  async searchJobsByStartDate(options, callback?: HarpeeResponseCallback<T>) {
    //      try {
    //          if (!Utils.isObject(options)) {
    //              throw new Error("`options` must be an object");
    //          }

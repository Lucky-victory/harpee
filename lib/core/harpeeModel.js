...
console.log(err)
    ...
    * @param {(Object | string[])} options - an array of column names or an object with options.
    ...
    * @param {(Array<string> | Object)} ids - an array of strings of your primaryKey values or an object.
    * @param {Array<string>} [ids.getAttributes] - when an object is provided,this let's you specify which columns to return. 
    * @param {responseCallback} [callback] - optional `callback` function, if not provided `Promise` is returned.
    * @example
    ...
    * @param {responseCallback} [callback] - optional `callback` function, if not provided `Promise` is returned.
    * @example
    * // **Note: the values and types specified here must match those specified in your `Schema` otherwise an error will be thrown**
 ...
 */
   ...
   /**
    * Return data from table using matching conditions, alias for {@link https://api.harperdb.io/#c820c353-e7f6-4280-aa82-83be77857653 | search_by_conditions operation}.
    * @param {Object} options
    ...
    * @param {object[]} options.searchValue - value you wish to search - wild cards are allowed..
    * @param {responseCallback} [callback] - optional `callback` function, if not provided `Promise` is returned.
    */

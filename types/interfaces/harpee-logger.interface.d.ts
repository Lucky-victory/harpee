...
export interface IHarperDBReadTransLogByUsernameOptions extends IHarpeeUtilOptions {
    /**
     * The HarperDB user for whom you would like to view transactions.
     */
    searchValues: string[];
}
export interface IHarperDBReadTransLogByTimestampOptions extends IHarpeeUtilOptions {
    /**

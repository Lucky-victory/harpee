...
export declare class HarpeeLogger extends HarpeeHttp {
     ...
     */
    readLog<T = object>(options: IHarpeeReadLogOptions, callback?: HarpeeResponseCallback<T>): Promise<import("../interfaces/harpee.interface").IHarpeeResponse<T> | undefined>;
    /**
    ...
    getJob<T = object[]>(options: {
        ...
        id: string;
    }, callback?: HarpeeResponseCallback<T>): Promise<import("../interfaces/harpee.interface").IHarpeeResponse<T> | undefined>;
    /**
      ...
      */
    readTransactionLog<T = object[]>(options: IHarpeeUtilOptions, callback?: HarpeeResponseCallback<T>): Promise<import("../interfaces/harpee.interface").IHarpeeResponse<T> | undefined>;
    /**
     ...
     */
    readTransactionLogByTimestamp<T = object[]>(options: IHarperDBReadTransLogByTimestampOptions, callback?: HarpeeResponseCallback<T>): Promise<import("../interfaces/harpee.interface").IHarpeeResponse<T> | undefined>;
    /**
     ...
     */
    readTransactionLogByUsername<T = object[]>(options: IHarperDBReadTransLogByUsernameOptions, callback?: HarpeeResponseCallback<T>): Promise<import("../interfaces/harpee.interface").IHarpeeResponse<T> | undefined>;
    /**
     ...
     */
    readTransactionLogByHashValue<T = object[]>(options: IHarperDBReadTransLogByHashOptions, callback?: HarpeeResponseCallback<T>): Promise<import("../interfaces/harpee.interface").IHarpeeResponse<T> | undefined>;
    /**
     ...
     */
    deleteRecordsBefore<T = IHarperDBMessageResponse>(options: IHarperDBDeleteRecordsOptions, callback?: HarpeeResponseCallback<T>): Promise<import("../interfaces/harpee.interface").IHarpeeResponse<T> | undefined>;
    /**
     *Deletes transaction log data for the specified database table that is older than the specified timestamp.
     *
     */
    deleteTransactionLogsBefore<T = unknown>(options: IHarperDBDeleteTransLogOptions, callback?: HarpeeResponseCallback<T>): Promise<import("../interfaces/harpee.interface").IHarpeeResponse<T> | undefined>;
    /**
     * Returns a list of job statuses, metrics, and messages for all jobs executed within the specified time window.
     *
     */
    searchJobsByStartDate<T = object[]>(options: IHarperDBSearchJobOptions, callback?: HarpeeResponseCallback<T>): Promise<import("../interfaces/harpee.interface").IHarpeeResponse<T> | undefined>;
}
